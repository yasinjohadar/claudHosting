...
<div class="main-content app-content admin-email-templates-page">
    <div class="container-fluid">
            ...
            <div class="row align-items-start g-3">
                <div class="col-lg-8">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <span class="group-show-hero__eyebrow">تعديل القالب</span>
                            <h2 class="group-show-hero__title mb-2">{{ $mailTemplate->name }}</h2>
                            <p class="group-show-hero__desc mb-0"><code>{{ $mailTemplate->key }}</code></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <form method="POST" action="{{ route('admin.mail-templates.update', $mailTemplate) }}" id="mailTemplateForm">
            @csrf
            @method('PUT')
