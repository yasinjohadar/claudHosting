                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            @include('partials.app-brand', ['brandContext' => 'header'])
                        </div>
                    </div>
                    <!-- End::header-element -->
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element headerProfile-dropdown">
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                            ...
                            <li>
                                @php
                                    $profileRoute = request()->is('client*') || request()->routeIs('client.*')
                                        ? 'client.profile.show'
                                        : 'profile.show';
                                @endphp
                                <a class="dropdown-item d-flex" href="{{ route($profileRoute) }}">
