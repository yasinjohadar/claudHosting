...
<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <input type="number" name="price" step="0.01" min="0" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $service?->price ?? 0) }}" required>
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="execution_duration" class="form-control" value="{{ old('execution_duration', $service?->execution_duration) }}" placeholder="مثال: 3–5 أيام عمل">
    </div>
    <div class="col-md-6">
        <label class="form-label">مدة التنفيذ (أيام)</label>
        <input type="number" name="execution_days" class="form-control" value="{{ old('execution_days', $service?->execution_days) }}" min="0" placeholder="اختياري">
    </div>
    <div class="col-12">
