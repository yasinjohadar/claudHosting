@php
    $tabs = [
        ...
        ['id' => 'siteTabBackups', 'key' => 'backups', 'icon' => 'fe fe-hard-drive', 'label' => 'النسخ الاحتياطي', 'hint' => 'إنشاء واستعادة', 'class' => 'cp-wp-tabs__item--backup'],
        ['id' => 'siteTabHosting', 'key' => 'hosting', 'icon' => 'fe fe-server', 'label' => 'الاستضافة', 'hint' => 'الباقة والعميل', 'class' => 'cp-wp-tabs__item--hosting'],
        ['id' => 'siteTabCyberPanel', 'key' => 'tools', 'icon' => 'fe fe-settings', 'label' => 'أدوات CyberPanel', 'hint' => 'ملفات ولوحة', 'class' => 'cp-wp-tabs__item--tools'],
    ];
@endphp
