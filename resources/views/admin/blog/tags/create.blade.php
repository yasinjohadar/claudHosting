...
<form action="{{ route('admin.blog.tags.store') }}" method="POST" enctype="multipart/form-data">@csrf
...
@include('admin.partials.seo-archive-panel', ['model' => null, 'archiveType' => 'tag'])
</div>
<div class="col-lg-4">
<div class="card custom-card"><div class="card-body">
<button type="submit" class="btn btn-primary w-100 mb-2"><i class="bi bi-save me-2"></i>حفظ الوسم</button>
