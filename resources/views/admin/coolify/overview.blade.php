    ...
    <div class="container-fluid">
        ...
        @if($apiListBlocked ?? false)
            <div class="alert alert-warning border-0 shadow-sm mb-4">
                <strong><i class="fe fe-alert-triangle me-1"></i> التوكن مرفوض — لا تُجلب المشاريع (401 Unauthenticated)</strong>
                <p class="small mb-2 mt-2">لوحة Coolify تعمل لكن <strong>API Token</strong> في Laravel غير صالح، منتهٍ، أو محجوب بـ Allowed IPs.</p>
                <ul class="small mb-2">
