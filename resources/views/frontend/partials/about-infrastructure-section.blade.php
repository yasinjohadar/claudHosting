    ...
    $categories = [
        [
            ...
            'items' => [
                ...
                ['icon' => asset('frontend/assets/images/tech/almalinux.svg'), 'type' => 'img', 'name' => 'AlmaLinux'],
                ['icon' => 'fab fa-cpanel', 'type' => 'fa', 'name' => 'cPanel'],
                ['icon' => 'fab fa-cpanel', 'type' => 'fa', 'name' => 'WHM', 'hint' => 'Web Host Manager'],
                ['icon' => asset('frontend/assets/images/tech/plesk.svg'), 'type' => 'img', 'name' => 'Plesk'],
        ...
        [
            ...
            'items' => [
                ...
                ['icon' => asset('frontend/assets/images/tech/qemu.svg'), 'type' => 'img', 'name' => 'KVM / VPS'],
                ['icon' => 'devicon-digitalocean-plain', 'type' => 'devicon', 'name' => 'Cloud VPS'],
                ['icon' => 'fas fa-scale-balanced', 'type' => 'fa', 'name' => 'Load Balancing'],
        ...
        [
            ...
            'items' => [
                ...
                ['icon' => asset('frontend/assets/images/tech/mariadb.svg'), 'type' => 'img', 'name' => 'MariaDB'],
                ...
                ['icon' => asset('frontend/assets/images/tech/minio.svg'), 'type' => 'img', 'name' => 'MinIO'],
            ],
        ],
        [
            'title' => 'الأمان والمراقبة',
            'desc' => 'حماية متعددة الطبقات ومراقبة مستمرة لاستقرار الخدمات.',
            'badge' => ['icon' => 'devicon-grafana-plain', 'type' => 'devicon'],
            'items' => [
                ['icon' => asset('frontend/assets/images/tech/cloudflare.svg'), 'type' => 'img', 'name' => 'WAF'],
                ['icon' => 'devicon-prometheus-original', 'type' => 'devicon', 'name' => 'Prometheus'],
                ['icon' => 'devicon-grafana-plain', 'type' => 'devicon', 'name' => 'Grafana'],
                ['icon' => asset('frontend/assets/images/tech/backblaze.svg'), 'type' => 'img', 'name' => 'نسخ احتياطي'],
                ['icon' => asset('frontend/assets/images/tech/letsencrypt.svg'), 'type' => 'img', 'name' => "Let's Encrypt"],
                ['icon' => asset('frontend/assets/images/tech/openssl.svg'), 'type' => 'img', 'name' => 'SSL / TLS'],
            ],
        ],
        [
            ...
            'items' => [
                ...
                ['icon' => asset('frontend/assets/images/tech/n8n.svg'), 'type' => 'img', 'name' => 'n8n'],
