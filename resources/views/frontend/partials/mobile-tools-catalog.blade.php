    ...
    $mobileCategories = [
        [
            ...
            'tools' => [
                ...
                ['name' => 'Material Design', 'icon' => asset('frontend/assets/images/tech/materialdesign.svg'), 'type' => 'img', 'task' => 'مكونات واجهة أندرويد الرسمية بتصميم متسق.'],
        ...
        [
            ...
            'tools' => [
                ['name' => 'GetX', 'icon' => asset('frontend/assets/images/tech/getx.svg'), 'type' => 'img', 'task' => 'State management، routing، وdependency injection خفيف.'],
                ...
                ['name' => 'Riverpod', 'icon' => asset('frontend/assets/images/tech/flutter.svg'), 'type' => 'img', 'task' => 'إدارة حالة آمنة مع compile-time checks.'],
        ...
        [
            ...
            'tools' => [
                ...
                ['name' => 'GraphQL', 'icon' => asset('frontend/assets/images/tech/graphql.svg'), 'type' => 'img', 'task' => 'استعلامات مرنة للبيانات من التطبيق.'],
                ['name' => 'Supabase', 'icon' => asset('frontend/assets/images/tech/supabase.svg'), 'type' => 'img', 'task' => 'Backend-as-a-Service مع Postgres وRealtime.'],
        ...
        [
            ...
            'tools' => [
                ...
                ['name' => 'Xcode', 'icon' => asset('frontend/assets/images/tech/xcode.svg'), 'type' => 'img', 'task' => 'توقيع وبناء IPA لنشر تطبيقات iOS.'],
                ...
                ['name' => 'Google Play', 'icon' => asset('frontend/assets/images/tech/googleplay.svg'), 'type' => 'img', 'task' => 'نشر وتحديث تطبيقات أندرويد على المتجر.'],
