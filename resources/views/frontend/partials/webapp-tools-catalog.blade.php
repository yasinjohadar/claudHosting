    ...
    $webappCategories = [
        ...
        [
            ...
            'tools' => [
                ...
                ['name' => 'GraphQL', 'icon' => asset('frontend/assets/images/tech/graphql.svg'), 'type' => 'img', 'task' => 'استعلامات مرنة للواجهات المعقدة.'],
            ],
        ],
        [
            ...
            'tools' => [
                ...
                ['name' => 'SQLite', 'icon' => asset('frontend/assets/images/tech/sqlite.svg'), 'type' => 'img', 'task' => 'تخزين خفيف للمشاريع الصغيرة والاختبار.'],
        ...
        [
            ...
            'tools' => [
                ['name' => 'Figma', 'icon' => asset('frontend/assets/images/tech/figma.svg'), 'type' => 'img', 'task' => 'نماذج UI/UX وتسليم تصميم للمطورين.'],
                ...
                ['name' => 'Jest / PHPUnit', 'icon' => asset('frontend/assets/images/tech/jest.svg'), 'type' => 'img', 'task' => 'اختبارات آلية لضمان استقرار الإصدارات.'],
