    ...
    <section class="page-banner page-banner-about">
        ...
        <div class="container position-relative">
            <div class="page-banner-content animate-on-scroll">
                <div class="page-banner-icon"><i class="fas fa-folder"></i></div>
                <h1 class="page-banner-title">{{ $category->name }} <span>— المدونة</span></h1>
        ...
        <div class="container">
            ...
            @else
                <div class="text-center py-5">
                    <p class="text-muted">لا توجد تدوينات في هذا التصنيف حالياً.</p>
