...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", window.__BOOTSTRAP_LTR_CSS__ || "/assets/libs/bootstrap/css/bootstrap.min.css");
    }
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", window.__BOOTSTRAP_RTL_CSS__ || "/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
    checkOptions();
}
