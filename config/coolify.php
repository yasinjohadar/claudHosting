...
return [
    ...
    */
    'keys' => [
        ...
        'wordpress_custom_domain_enabled' => 'coolify_wordpress_custom_domain_enabled',
        'wordpress_docker_tag' => 'coolify_wordpress_docker_tag',
        'wordpress_filebrowser_enabled' => 'coolify_wordpress_filebrowser_enabled',
        'wordpress_filebrowser_subdomain_prefix' => 'coolify_wordpress_filebrowser_subdomain_prefix',
        'wordpress_filebrowser_subdomain_style' => 'coolify_wordpress_filebrowser_subdomain_style',
        'wordpress_filebrowser_open_mode' => 'coolify_wordpress_filebrowser_open_mode',
        'wordpress_filebrowser_admin_username' => 'coolify_wordpress_filebrowser_admin_username',
        'wordpress_filebrowser_password_length' => 'coolify_wordpress_filebrowser_password_length',
    ...
    'defaults' => [
        ...
        'wordpress_custom_domain_enabled' => '1',
        'wordpress_docker_tag' => 'latest',
        'wordpress_filebrowser_enabled' => '1',
        'wordpress_filebrowser_subdomain_prefix' => 'files',
        'wordpress_filebrowser_subdomain_style' => 'flat',
        'wordpress_filebrowser_open_mode' => 'embed',
        'wordpress_filebrowser_admin_username' => 'admin',
        'wordpress_filebrowser_password_length' => '20',
